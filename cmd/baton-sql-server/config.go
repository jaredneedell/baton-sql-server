...
var cfg = field.Configuration{
	Fields: []field.SchemaField{dsn, dbHost, dbPort, skipUnavailableDatabases, appName, windowsLoginEmailDomain, c1ApiClientId, c1ApiClientSecret, c1AppId, c1EntitlementId},
}
